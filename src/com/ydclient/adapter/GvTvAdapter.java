...
import com.ydclient.activity.TvCtrlPage;
 ...
 * 
 */
public class GvTvAdapter extends SuperAdapter {

	public GvTvAdapter(Context context) {
		super(context);
	}
		...
		public void setListener() {
			clickListener = new OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent = new Intent(mContext, TvCtrlPage.class);
			...
			builder.setItems(new String[] { mContext.getString(R.string.update_device), mContext.getString(R.string.delete_device) }, new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					switch (which) {
					case 0:
						Intent intent = new Intent(mContext, TvLearnPage.class);
						intent.putExtra("DeviceInfo", deviceInfo);
						mContext.startActivity(intent);
						break;
					case 1:
