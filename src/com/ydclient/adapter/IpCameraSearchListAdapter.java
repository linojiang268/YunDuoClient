...
public class IpCameraSearchListAdapter extends BaseAdapter {
	...
	public IpCameraSearchListAdapter(Context ct){
		context = ct;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = listContainer.inflate(R.layout.item_ipcamera_search_list, null);    
...
//		}else{
//		}
		convertView.setBackgroundResource(R.drawable.ipcamera_listitem_bg_selector);
