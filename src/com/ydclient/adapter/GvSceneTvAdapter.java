...
import com.ydclient.activity.SceneTvPage;
import com.ydclient.model.DeviceInfo;

public class GvSceneTvAdapter extends SuperAdapter {
	private CallStartActivityForResult callStartActivityForResult;

	// private Gson gson;
	public GvSceneTvAdapter(Context context, CallStartActivityForResult callStartActivityForResult) {
		super(context);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_gv_tv, null);
		...
		public void setListener() {
			clickListener = new OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent = new Intent(mContext, SceneTvPage.class);
