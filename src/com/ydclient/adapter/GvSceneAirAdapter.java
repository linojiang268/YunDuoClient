...
import com.ydclient.activity.SceneAirPage;
import com.ydclient.model.DeviceInfo;

public class GvSceneAirAdapter extends SuperAdapter {
	private CallStartActivityForResult callStartActivityForResult;

	// private Gson gson;
	public GvSceneAirAdapter(Context context, CallStartActivityForResult callStartActivityForResult) {
		super(context);
		...
		public void setListener() {
			clickListener = new OnClickListener() {
				...
				public void onClick(View v) {
					Intent intent = new Intent(mContext, SceneAirPage.class);
